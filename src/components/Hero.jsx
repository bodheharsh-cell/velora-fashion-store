...
function Hero() {
  return (
    <div className="relative h-[90vh] w-full bg-gray-100 overflow-hidden">
      <img 
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-white text-5xl md:text-7xl font-bold tracking-tight mb-6 drop-shadow-lg uppercase">
          The New Elegance
        </h1>
        <p className="text-white text-lg md:text-xl font-light mb-10 max-w-lg drop-shadow-md">
